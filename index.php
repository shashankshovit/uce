...
if(stristr($ua,'android') == true) { // && stripos($ua,'mobile') !== false) {
...
//if($isMobile) 
{
	header("Location: ./mobile/devicecheck.php?mobiledevice=true");
?>
<!--	<script type="text/javascript">
		width = screen.width;
			window.location = "./mobile/devicecheck.php?width="+width;
	</script>	
-->
<?php	
} else header("Location:./index/index.php");
//} else header("Location:./mobile/devicecheck.php?width=".nojv);
?>
