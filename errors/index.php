            ...
            <div class="cs_wrapper">
                <div class="cs_slider">
                    ...
                    <div class="cs_article">
                        <a href="#">
							<img src="../images/errors/error1.png" alt="error image" width="250" height="200"/>
                        </a>				
                        <div class="text">
                            <h2> <a href="#">Error Message</a> </h2>
                            
                            <p>
                            Sorry !!! You dont have enough permissions to view the contents. OR you (by mistake) tried to access a wrong address/ link. This generally happens when you try to access a link which is incomplete or does not contain a valid address. Please check the address you typed and try again.
                            </p>
